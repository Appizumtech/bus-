      ...
      <div class="our_room">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <p class="margin_0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-4 col-sm-6">
                  <div id="serv_hover" class="room">
                     <div class="room_img">
                        <figure><img src="images/bus1.jpg" alt="#"></figure>
                     </div>
                     <div class="bed_room">
                        <ul class="bs-info">
                           <li><i class="fa-solid fa-gas-pump"></i> 200 Liters</li>
                           <li><i class="fa-solid fa-users"></i>50 Seats</li>
                           <li><i class="fa-solid fa-bus"></i>Manual</li>
                        </ul>
                        <div class="bus-rate">
                           <div class="bs-price">
                              <p>Rs.1500/-</p>
               ...
               <div class="col-md-4 col-sm-6">
                  <div id="serv_hover" class="room">
                     <div class="room_img">
                        <figure><img src="images/bus2.jpg" alt="#"></figure>
                     </div>
                     <div class="bed_room">
                        <ul class="bs-info">
                           <li><i class="fa-solid fa-gas-pump"></i> 200 Liters</li>
                           <li><i class="fa-solid fa-users"></i>100 Seats</li>
                           <li><i class="fa-solid fa-bus"></i>Manual</li>
                        </ul>
                        <div class="bus-rate">
                           <div class="bs-price">
